...
import com.example.coagusearch.network.notifications.model.NotificationsApi
...
class RetrofitClient(
    ...
    fun notificationsApi():NotificationsApi=getRetrofit().create(NotificationsApi::class.java)
